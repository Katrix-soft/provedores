// TODO: Restaurar login real antes de producción (ver commit anterior)
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _handleLogin() async {
    ...
    // BYPASS DE PRUEBAS — reemplazar con login real antes de producción
